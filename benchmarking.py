...
def main(m, n, t):
    ...
    plt.hist(distribution_error,density=True,bins=np.arange(0.5, 1, 0.5/250),align='mid',color='blueviolet',alpha =0.8,label=''r'$\mathbf{p}_{error}$')
    ...
    plt.plot(x, stats.norm.pdf(x, p_error, sigma_error), color='blueviolet')
    plt.xlim(0.5,1)
    plt.ylim(0,63)
    plt.xlabel('Accuracy')
