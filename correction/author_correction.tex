...
\makeatother
\subtitle{For `Quantum computation capability verification protocol for noisy
intermediate-scale quantum devices with the dihedral coset problem'}
\author{Ruge Lin}
\date{17 August 2026}
...
Ruge Lin and Weiqiang Wen, ``Quantum computation capability verification protocol for noisy
intermediate-scale quantum devices with the dihedral coset problem,''
